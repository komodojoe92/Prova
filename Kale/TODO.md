* Show Tag by File: in the data page display a box with the list of files and once a file is selected automatically highlight which are the tags associated with it.
